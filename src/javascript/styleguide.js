...
<span class="gray">Практически все</span> композиции следует выстраивать «слипшимися»,
          <br />однако<span class="gray">, стоит помнить о «воздухе» и гармонии и</span> не забывать
          оставлять <br />
          пустое пространство.
`
const compositionToggle = `
Практически все композиции следует выстраивать «слипшимися»,
          <br />однако, стоит помнить о «воздухе» и гармонии и не забывать
          оставлять <br />
          пустое пространство.
`

const pravilaThreeDefault = `
