const clothesRecyclingPlaces = [
  ...
  {
    name:
      'Пункт сбора фонда ВТОРОЕ ДЫХАНИЕ, Charity shop, ул. Садовая-Спасская',
  ...
  {
    name:
      'Пункт приема, Novaya Riga Outlet Village,Центральная ул., 33, д. Покровское',
