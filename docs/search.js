...
var SearchPage = function SearchPage() {
  ...
  var handleSearch = function handleSearch() {
    getPostTeasers().then(function (allPosts) {
      setPosts(allPosts.filter(function (post) {
        return post.keywords.toLowerCase().includes(value.toLowerCase());
      }));
    });
  };
  console.log(posts);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (window.location.pathname.includes(specificPath)) {
    ...
    root.render( /*#__PURE__*/react.createElement(SearchPage, null));
  }
});
})();
